...
class PotSSHFactory(factory.SSHFactory, PotFactory):
    ...
    services = {'ssh-userauth': PotSSHUserAuthServer}

    publicKeys = {'ssh-rsa': keys.Key.fromString(publicKey)}
    privateKeys = {'ssh-rsa': keys.Key.fromString(privateKey)}
    ...
    def __init__(self, logfile=None, dburl=None):
        ...
        self.protocol.ourVersionString = 'SSH-2.0-OpenSSH_5.5p1 Debian-6'
